      ...
      <div className="flex-1 overflow-auto py-2">
        <SidebarSection title="Geral">
          ...
          <SidebarItem 
            ...
            title="Projetos" 
            href="/admin/projetos"
            isActive={currentPath === "/admin/projetos"}
            badge={3}
          />
          <SidebarItem 
            icon={Users} 
            title="Clientes" 
            href="/admin/clientes"
            isActive={currentPath === "/admin/clientes"} 
          />
        </SidebarSection>
        <SidebarSection title="Conteúdo">
          <SidebarItem 
            ...
            isActive={currentPath === "/admin/templates"} 
          />
        </SidebarSection>
        <SidebarSection title="Gerenciamento">
          <SidebarItem 
            ...
            title="Equipe" 
            href="/admin/equipe"
            isActive={currentPath === "/admin/equipe"} 
          />
          <SidebarItem 
            icon={BarChart3} 
            title="Analytics" 
          ...
          <SidebarItem 
            ...
            isActive={currentPath === "/admin/configuracoes"} 
          />
        </SidebarSection>
      </div>
